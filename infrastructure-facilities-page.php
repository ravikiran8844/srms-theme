<?php
/**
 * Template Name: Infrastructure and Facilities Page
           ...
           <div class="col-12 p-2 mb-5">
            ...
            <div class="row guidelines-section_item">
                <div class="col-lg-5 p-0 <?php echo esc_attr($order_class); ?>">
                    <img  width="543" height="593" class="guidelines-section_item-img img-fluid" src="<?php echo esc_url($image); ?>" alt="<?php echo esc_attr($title); ?>">
                </div>
